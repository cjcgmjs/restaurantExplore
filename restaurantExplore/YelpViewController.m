...
- (void)viewDidLoad {
    ...
    [[YelpNetworking sharedInstance] fetchRestaurantsBasedOnLocation:loc term:@"sushi" parameters:[self _generateNetworRelatedParaMeters] completionBlock:^(NSArray<YelpDataModel *> *dataModelArray) {
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    [searchBar resignFirstResponder];  // responder to editing
